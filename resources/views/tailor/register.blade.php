    ...
    <div class="container">
        <div class="register-container">
            ...
            <div class="register-form">
                <h2 class="text-center mb-4">Tailor Registration</h2>
                @if(session('success'))
                ...
                <form action="{{ route('tailor.register.submit') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="register-footer text-center">
                    <p>Already have an account? <a href="{{ route('tailor.login') }}">Login here</a></p>
                </div>
            </div>
        </div>
    </div>
